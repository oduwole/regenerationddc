let slide_data = [
    {
      ...
      'title':'The FolaJomi Court',
      'copy':'The Folajomi Court comprises a total of 44 total Apartments <br />22 Nos Two Bedroom apartment with detached BQ. <br /> Features also include a Swimming Pool, Gym, Green Areas etc'
    },
    {
  ...
  for (let i = 0; i< slide_data.length; i++){
    ...
    right_div.classList.add('slide');
    //slide.setAttribute('style','background:url('+slide_data[i].src+')');
    right_div.setAttribute('style','background:url('+slide_data[i].src+')');

    caption.classList.add('caption');
    slide_title.classList.add('caption-heading');
    slide_title.innerHTML = '<h1>'+slide_data[i].title+'</h1>';

    slide.appendChild(left_div);
    slide.appendChild(right_div);
